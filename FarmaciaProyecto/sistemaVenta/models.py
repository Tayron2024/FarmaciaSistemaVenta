...
class Usuario(AbstractUser):
    ...
    groups = models.ManyToManyField(
        'auth.Group',
        related_name='custom_user_groups_sistemaVenta',  # Cambiar el related_name para evitar el conflicto
        blank=True,
    ...
    user_permissions = models.ManyToManyField(
        'auth.Permission',
        related_name='custom_user_permissions_sistemaVenta',  # Cambiar el related_name para evitar el conflicto
        blank=True,
